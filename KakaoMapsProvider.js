export class KakaoMapsProvider {
    constructor() {
        ...
        // Coverage warning
        this.coverageWarningElement = null;
        this.lastKnownValidPosition = null;
    }
    ...
    createCoverageWarning(mapContainer) {
    ...
    isWithinKakaoCoverage(position) {
        const bounds = {
            north: 43.0,
            south: 33.0,
            east: 132.0,
    ...
    applyPendingPov() {
        if (!this.roadview || this.pendingHeading === null || this.pendingPitch === null)
            return;
    ...
    setRoadviewPosition(position, heading, pitch) {
...
//# sourceMappingURL=KakaoMapsProvider.js.map