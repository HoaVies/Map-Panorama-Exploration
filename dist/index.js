    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (currentProviderType === 'kakao') {
                ...
                const kakaoProvider = currentProvider;
                try {
            ...
            if (currentProviderType === 'kakao' && arguments_1[0] === 'mapycz') {
